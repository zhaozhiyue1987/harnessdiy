...
| [`mcp-dsh/`](mcp-dsh/README.md) | base 之上的 MCP 服务器目录与会话级绑定 | —（仅 patch） |
| [`higress-trace/`](higress-trace/README.md) | 可选 Higress Trace 反查与本地 OTLP 组合 | 挂载一个反查 Provider 和 telemetry |
