...
来源：[`packages/mcp/mcp-client/src/index.ts:147`](../packages/mcp/mcp-client/src/index.ts)
...
- `@deepseek-ai/dsh-mcp-manager` — 需要 `settings`（[`packages/mcp/mcp-manager/src/index.ts`](../packages/mcp/mcp-manager/src/index.ts)）
