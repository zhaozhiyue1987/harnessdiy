...
Source: [`packages/telemetry/telemetry-otel/src/index.ts:32`](../packages/telemetry/telemetry-otel/src/index.ts)
...
- `@deepseek-ai/dsh-mcp-manager` — requires `settings` ([`packages/mcp/mcp-manager/src/index.ts`](../packages/mcp/mcp-manager/src/index.ts))
...
- `@deepseek-ai/dsh-telemetry` — abstract `TraceTelemetry` ([`packages/telemetry/telemetry/src/index.ts`](../packages/telemetry/telemetry/src/index.ts))
