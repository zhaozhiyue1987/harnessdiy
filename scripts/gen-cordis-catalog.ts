...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ActiveTraceSpan: 'telemetry.md',
  Agent: 'core.md',
  AgentCancelCause: 'core.md',
  AgentFactory: 'core.md',
  AgentHandle: 'core.md',
  ModelSelection: 'core.md',
  OutboundTraceContext: 'telemetry.md',
  TraceAgentIdentity: 'telemetry.md',
  TraceSpanOptions: 'telemetry.md',
  AgentOptions: 'core.md',
  AgentStatus: 'core.md',
  GatewayTraceLookup: 'gateway-trace.md',
  GatewayTraceObservation: 'gateway-trace.md',
